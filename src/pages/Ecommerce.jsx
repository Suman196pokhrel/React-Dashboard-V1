  ...
  return (
    <div className='mt-12'>
      ...
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        rounded-xl w-full lg:w-80 p-10 pt-10 
        ...
        >
          <div className='flex justify-between items-center pt-17'>
            <div>
              ...
              <p className='text-3xl dark:bg-secondary-dark-bg dark:text-gray-200 '>$63,444.80</p>
            </div>
          </div>
        ...
        p-6 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-evenly p-5'>
            <div className='border-r-1 border-color m-4 pr-10'>
              ...
              <div>
                <p>
                  <span className='text-3xl font-semibold'>$93,454.88</span>
                  <span className='
                  p-1.5 hover:drop-shadow-xl 
                  -pointer rounded-full text-white 
                  bg-green-400 ml-3 tex-xs'
                  >
                    23%
                    </span>
                </p>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>$43,454.88</span>
                </p>
